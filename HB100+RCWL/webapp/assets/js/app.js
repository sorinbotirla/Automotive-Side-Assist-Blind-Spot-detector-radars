var RadarLogger = function(){
    ...
    _self.settingsPopulate = function(o){
        ...
        if (typeof o.MIN_ACTIVE_SPEED !== "undefined") {
            _self.settingsCache["MIN_ACTIVE_SPEED"] = o.MIN_ACTIVE_SPEED;
            _self.setFieldValueIfExists("MIN_ACTIVE_SPEED", o.MIN_ACTIVE_SPEED);
        }
